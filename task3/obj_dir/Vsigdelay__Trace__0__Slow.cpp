...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+14,"incr", false,-1, 7,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,(vlSelf->sigdelay__DOT____Vcellout__myCounter__count),9);
    bufp->fullCData(oldp+9,(vlSelf->sigdelay__DOT____Vcellout__myCounter__count),8);
    bufp->fullSData(oldp+10,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count) 
                                        + (IData)(vlSelf->offset)))),9);
    bufp->fullSData(oldp+11,(vlSelf->sigdelay__DOT__rd_addr),9);
    bufp->fullIData(oldp+12,(8U),32);
    bufp->fullBit(oldp+13,(1U));
    bufp->fullCData(oldp+14,(1U),8);
