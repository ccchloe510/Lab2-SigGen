...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+7,(vlSelf->sigdelay__DOT____Vcellout__myCounter__count),9);
    bufp->chgCData(oldp+8,(vlSelf->sigdelay__DOT____Vcellout__myCounter__count),8);
    bufp->chgSData(oldp+9,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count) 
