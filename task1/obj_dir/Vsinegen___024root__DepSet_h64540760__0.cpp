...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__sinegen__DOT__counter_value;
    __Vdly__sinegen__DOT__counter_value = 0;
    // Body
    __Vdly__sinegen__DOT__counter_value = vlSelf->sinegen__DOT__counter_value;
    if (vlSelf->rst) {
        __Vdly__sinegen__DOT__counter_value = 0U;
    } else if (vlSelf->en) {
        __Vdly__sinegen__DOT__counter_value = (0xffU 
                                               & ((IData)(vlSelf->sinegen__DOT__counter_value) 
                                                  + (IData)(vlSelf->incr)));
    }
    vlSelf->dout = vlSelf->sinegen__DOT__myRom__DOT__sine_wave_rom
        [vlSelf->sinegen__DOT__counter_value];
    vlSelf->sinegen__DOT__counter_value = __Vdly__sinegen__DOT__counter_value;
}
