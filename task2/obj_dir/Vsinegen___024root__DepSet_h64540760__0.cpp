...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    vlSelf->data1 = vlSelf->sinegen__DOT__myRom__DOT__sine_wave_rom
        [vlSelf->sinegen__DOT__addr1];
    vlSelf->data2 = vlSelf->sinegen__DOT__myRom__DOT__sine_wave_rom
        [(0xffU & ((IData)(vlSelf->offset) + (IData)(vlSelf->sinegen__DOT__addr1)))];
